...
import Libreria_Producto as lpro
    ...
    with tabs[2]:
        ...
        with st.expander("Agregar Producto"):
            ...
            if st.button("Agregar Producto"):
                lpro.agregar_producto(id_creacion, nombre_creacion, precio, cantidad)
        ...
        with st.expander("Actualizar Producto"):
            ...
            if st.button("Actualizar Producto"):
                lpro.actualizar_producto(id_actualizacion, nombre_actualizado, precio_actualizado, cantidad_actualizada)
        ...
        with st.expander("Eliminar Producto"):
            ...
            if st.button("Eliminar Producto"):
                lpro.eliminar_producto(id_eliminacion)
